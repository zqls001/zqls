...
public class UmsUserAccountRechargeExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addAmountCriterion(String condition, Object value, String property) {
            ...
            amountCriteria.add(new Criterion(condition, value, "com.duanxin.zqls.data.handler.MoneyTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addAmountCriterion(String condition, Money value1, Money value2, String property) {
            ...
            amountCriteria.add(new Criterion(condition, value1, value2, "com.duanxin.zqls.data.handler.MoneyTypeHandler"));
            allCriteria = null;
        }
