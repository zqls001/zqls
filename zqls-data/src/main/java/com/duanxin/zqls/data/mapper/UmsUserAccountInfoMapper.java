...
import com.duanxin.zqls.data.model.UmsUserAccountInfo;
import com.duanxin.zqls.data.model.UmsUserAccountInfoExample;
...
public interface UmsUserAccountInfoMapper {
    ...
    @Insert({
        ...
        "type, flow_id)",
        "values (#{aid,jdbcType=CHAR}, #{balance,jdbcType=BIGINT,typeHandler=com.duanxin.zqls.data.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.duanxin.zqls.data.mapper.UmsUserAccountInfoMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set aid = #{aid,jdbcType=CHAR},",
          "balance = #{balance,jdbcType=BIGINT,typeHandler=com.duanxin.zqls.data.handler.MoneyTypeHandler},",
