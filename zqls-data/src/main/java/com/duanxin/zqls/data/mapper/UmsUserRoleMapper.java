...
import com.duanxin.zqls.data.model.UmsUserRole;
import com.duanxin.zqls.data.model.UmsUserRoleExample;
...
public interface UmsUserRoleMapper {
    ...
    @Select({
        "select",
        "id, uid, rid, operate_time, operate_ip, operator",
        "from ums_user_role",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @ResultMap("com.duanxin.zqls.data.mapper.UmsUserRoleMapper.BaseResultMap")
