...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='反馈基本表';
...
CREATE TABLE `ums_user_account_info` (
  ...
  `aid` char(9) NOT NULL DEFAULT '' COMMENT '用户帐号',
...
CREATE TABLE `ums_user_info` (
  ...
  `aid` char(9) NOT NULL COMMENT '用户帐号',
  ...
  CONSTRAINT `ums_user_info_ums_user_account_info__fk` FOREIGN KEY (`aid`) REFERENCES `ums_user_account_info` (`aid`)
...
-- Dump completed on 2019-09-15 17:11:31
